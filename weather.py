...
class WeatherApp(QWidget):
    ...
    def get_weather(self):
        ...
        try:
            ...
            response.raise_for_status() #the usual "try" generally doesn't catch http errors which is why we use 
            #raise_for_status() medthod to raise an exception incase of an HTTP ERROR
            data = response.json()
